...
setup_envs() {
  ...
  BUILDER_MOUNT_OPTS="
    ...
    -v '${HOST_KEY_BUILD}:${BUILDER_APK_KEY_BUILD}'
    -v '${HOST_KEY_BUILD_PUB}:${BUILDER_APK_KEY_BUILD_PUB}'
  ...
  _set_env BUILDER_IMAGE_ID_BUILDENV BUILDER_CONTAINER_ID BUILDER_WORK_DIR BUILDER_TMP_DIR BUILDER_BIN_DIR BUILDER_PROFILE_DIR BUILDER_KEY_BUILD BUILDER_KEY_BUILD_PUB BUILDER_APK_KEY_BUILD BUILDER_APK_KEY_BUILD_PUB BUILDER_MOUNT_OPTS
  append_docker_exec_env BUILDER_WORK_DIR BUILDER_TMP_DIR BUILDER_BIN_DIR BUILDER_PROFILE_DIR BUILDER_KEY_BUILD BUILDER_KEY_BUILD_PUB BUILDER_APK_KEY_BUILD BUILDER_APK_KEY_BUILD_PUB
